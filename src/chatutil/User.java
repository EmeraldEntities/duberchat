...
public class User implements Serializable {
  ...
  /**
   * Constructor for a user when no profile picture exists, used when first making an account.
   * @param username  The user's username.
   * @param userId    The user's id, corresponding to being the nth user registered on the server.
   */
  ...
  /**
   * Retrieves the user's id number, which corresponds to being the nth user in the server.
